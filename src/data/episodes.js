...
Object.assign(EPISODES, {
  'N-SC02': makeNearbyRpgEpisode({
    characters: [
      { name: { zh: '数字生态观察员', en: 'Digital Ecosystem Observer' }, role: { zh: '南山科技生态讲述人', en: 'Nanshan Tech Ecosystem Guide' }, portrait: './public/assets/episodes/tencent/npc-cutout.png' },
    ],
    intro: {
    ...
    background: './public/assets/episodes/tencent/stage-bg.png',
  ...
  'N-AW04': makeNearbyRpgEpisode({
    characters: [
      { name: { zh: '围村宴席记录人', en: 'Walled Village Banquet Keeper' }, role: { zh: '元朗盆菜文化讲述人', en: 'Yuen Long Poon Choi Guide' }, portrait: './public/assets/episodes/yuenlong/npc-cutout.png' },
    ],
    ...
    background: './public/assets/episodes/yuenlong/stage-bg.png',
  ...
  'N-EG02': makeNearbyRpgEpisode({
    characters: [
      { name: { zh: '制度档案员', en: 'Market Archive Keeper' }, role: { zh: '资本市场改革讲述人', en: 'Capital Market Reform Guide' }, portrait: './public/assets/episodes/szse/npc-cutout.png' },
    ],
    ...
    background: './public/assets/episodes/szse/stage-bg.png',
  ...
  M11: makeNearbyRpgEpisode({
    characters: [
      { name: { zh: '改革见证者', en: 'Witness of Reform' }, role: { zh: '莲花山城市记忆讲述人', en: 'Lianhua Mountain Memory Guide' }, portrait: './public/assets/episodes/lianhua/npc-cutout.png' },
    ],
    ...
    background: './public/assets/episodes/lianhua/stage-bg.png',
  ...
  'N-EG10': makeNearbyRpgEpisode({
    characters: [
      { name: { zh: '跨海工程师', en: 'Cross-Sea Engineer' }, role: { zh: '深中通道现场讲述人', en: 'Shenzhen-Zhongshan Link Site Guide' }, portrait: './public/assets/episodes/shenzhong/npc-cutout.png' },
    ],
    ...
    background: './public/assets/episodes/shenzhong/stage-bg.png',
  ...
  M08: makeNearbyRpgEpisode({
    characters: [
      { name: { zh: '金融先行者', en: 'Financial Pioneer' }, role: { zh: '前海制度试验讲述人', en: 'Qianhai Policy Experiment Guide' }, portrait: './public/assets/episodes/qianhai/npc-cutout.png?v=rpg-assets-fix-2' },
    ],
    intro: {
    ...
    background: './public/assets/episodes/qianhai/stage-bg.png',
  ...
  M06: makeNearbyRpgEpisode({
    characters: [
      { name: { zh: '袁庚', en: 'Yuan Geng' }, role: { zh: '蛇口工业区创始人', en: 'Founder of Shekou Industrial Zone' }, portrait: './public/assets/episodes/shekou/npc-cutout.png?v=rpg-assets-fix-2' },
    ],
    intro: {
    ...
    background: './public/assets/episodes/shekou/stage-bg.png',
  ...
  'N-SC03': makeNearbyRpgEpisode({
    characters: [
      { name: { zh: '汪滔', en: 'Frank Wang' }, role: { zh: '大疆创始人', en: 'DJI Founder' }, portrait: './public/assets/episodes/dji/npc-cutout.png?v=rpg-assets-fix-2' },
    ],
    intro: {
    ...
    background: './public/assets/episodes/dji/stage-bg.png',
  ...
  M01: makeNearbyRpgEpisode({
    characters: [
      { name: { zh: '郑和', en: 'Zheng He' }, role: { zh: '大明宝船统帅', en: 'Admiral of the Treasure Fleet' }, portrait: './public/assets/episodes/chiwan/npc-cutout.png?v=rpg-assets-fix-2' },
    ],
    intro: {
    ...
    background: './public/assets/episodes/chiwan/stage-bg.png',
  ...
  M07: makeNearbyRpgEpisode({
    characters: [
      { name: { zh: '湿地守护者', en: 'Wetland Guardian' }, role: { zh: '红树林生态讲述人', en: 'Mangrove Ecology Guide' }, portrait: './public/assets/episodes/mangrove/npc-cutout.png?v=rpg-assets-fix-2' },
    ],
    intro: {
    ...
    background: './public/assets/episodes/mangrove/stage-bg.png',
